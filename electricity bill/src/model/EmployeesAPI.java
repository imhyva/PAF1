...
String output = ebillObj.insertEbill( request.getParameter("id"),
...
paras.get("meterreading").toString(),
...
protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	//parameter map
	Map<?, ?> paras = getParasMap(request); //getting values from the map and sending to delete f
